    ...
    const mero = [
...

      {
        ...
        opis_big:
          ...
          '</p>' 
          + '<br/>'         
          + 'Данный пятидневный курс позволит обучиться гипнозу, даже человеку не имеющему специальных знаний или профильного образования. Достаточно иметь трезвый ум и осознанное желание изучить гипноз. Так же данная программа будет полезна и состоявшемуся профессионалу. Вы сможете делать ещё лучше, то что делаете. Вы сможете.'
          + '<br/>'
          +'- Вводить клиента в гипноз удаленно по видео связи или при личной встрече.'
          + '<br/>'
          +'— Изучить и овладеть несколькими быстрыми шоковыми и без шоковыми техниками погружения.'
          + '<br/>'
          +'— Овладеть регрессивным гипнозом.'
          + '<br/>'
          +'— Узнать как успешно вести стратегическую линию при лечении страхов, фобий, панических атак и иных заболеваний и расстройств психосоматического характера.'
          + '<br/>'
          +'— При необходимости проработать свои личностные запросы.'
          +          '<h2 class="text-3xl pt-7 pb-3" >' 
          +'План обучающего семинара'
          +'</h2>' 
          + '<p>'
          +'<br/><b>1 день.</b><br/>Понятие гипноза. Понятие транса. Что такое Рапорт. Терминология. Животный магнетизм. Упражнение для постановки гипнотической речи. Особенности гипнотического взгляда. Основные техники погружение в транс'
          + '</p>'
          + '<p>'
          +'<br/><b>2 день.</b> <br/>Сознание. Подсознание. Бессознательное. Техники присоединения. Сигнальные системы. Система 1-человек разумный. Система 2 — примативная или обезьяна. Индукция Элмана в классическом исполнении. Директивный гипноз. Отработка рапорта в парах. Домашнее задание.'
          + '</p>'
          + '<p>'
          +'<br/><b>3 день.</b> <br/>Способы быстрого присоединения. Трёх ступенчатая ракета при терапии «по Пыживски». Трёх ступенчатая ракета « Эльмана Османова» Простые сложные вопросы. Работа по видео связи. Техника безопасности. Практическая отработка с приглашенными гипномоделями.                                                                                      '
          + '</p>'
          + '<p>'
          +'<br/><b>4 день.</b><br/> Терапия. Стратегические пути и линии при лечение психосоматических расстройств и заболеваний. Выделение субличности. Кодирование от алкогольной зависимости. Работа с ожирением. Выход на улицу, для отработки техник.                                                                                                                                                                                                                     '
          + '</p>'
          + '<p>'
          +'<br/><b>5 день.</b><br/> Целительство. Молитвотерапия. Обряды. Заговоры. Что такое порча. Способы защиты. Ментальный гипноз. Фантом. Работа с энергополем. Хождение по битым стёклам.'
          + '</p>'
          ,
