    ...
    const mero = [
      ...
      },
      {
        ...
        opis_big:
          ...
          'Номинация «Целитель года» :' +
          'Целитель — Специалист безмедикаментозного лечения- высшей категории.' +
          '2. Целитель — Специалист безмедикаментозного лечения- общего направления.' +
          'Номинация Экстрасенс года:' +
          'Экстрасенс — практик высшей категории' +
          '2. Экстрасенс — практик общего направления.' +
          'Гипнотизёр года:' +
          'Гипнотизер — специалист высшей категории.' +
