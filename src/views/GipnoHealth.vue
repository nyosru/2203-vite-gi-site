...
<a href="#t1" >ссылка{{ o }}</a>
    ...
    <gipno-health-block-learning></gipno-health-block-learning>
    
    <gipno-health-block-leckar></gipno-health-block-leckar>

  <block-sell></block-sell>

    <!-- <info-gipnoz></info-gipnoz> -->

    <poezdki></poezdki>

    <!-- 
    <div v-for="u in 3" :key="u">
      <br />
      <br />
      <br />
      <br />
        ...
        <div class="w-full mx-auto flex flex-wrap items-center">
          ...
          >
            ...
            >
              ...
              <div class="container xpx-2 pb-8">
        <div class="w-full text-center">
          <A href="https://php-cat.com" class="inline-block text-gray-300 no-underline hover:text-gray-200 hover:underline" target="_blank" >Создание сайта php-cat.com</a>
      </div>
      </div>
    </footer>
  </div>
...
<script>
import GipnoHealthHeader from './GipnoHealthHeader.vue'
import GipnoHealthBlockLeckar from './GipnoHealthBlockLeckar.vue'
// import ButtonRepo from './../ButtonRepo.vue'

import InfoGipnoz from './informer/Gipnoz.vue'

import poezdki from './GipnoHealthPoezdPlans.vue'
import BlockSell from './GipnoHealthBlockSellLekar.vue'
import GipnoHealthBlockLearning from './GipnoHealthBlockLearning.vue'
// import { ref } from 'vue'
...
export default {
  ...
  components: {
    poezdki,
    GipnoHealthHeader,
    GipnoHealthBlockLeckar,
    InfoGipnoz,
    BlockSell,
    GipnoHealthBlockLearning,
  },
}
</script>
